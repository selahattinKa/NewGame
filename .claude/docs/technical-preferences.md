...
- **Language**: C#
- **Rendering**: URP (Universal Render Pipeline) — mobil 2D için en uygun
...
- **Touch Support**: Full
- **Platform Notes**: Tüm UI touch-friendly olmalı — minimum dokunma hedefi 44x44 dp. Hover-only etkileşim yok.
