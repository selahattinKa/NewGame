...
5. **GIVEN** Büyücü pet Element Dalgası (ATK=35, multiplier=0.75, büyü hasarı) vs 3 düşman (DEF: 35, 15, 17), nötr, **WHEN** yetenek kullanılırsa, **THEN** boosted=floor(35×0.75)=26; her hedefe: floor(26-floor(35/4))=floor(26-8)=**18**, floor(26-floor(15/4))=floor(26-3)=**23**, floor(26-floor(17/4))=floor(26-4)=**22**. Toplam=**63**.
